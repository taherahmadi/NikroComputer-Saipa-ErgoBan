 ...
 */
public class DefaultWindDataset extends AbstractXYDataset implements
		WindDataset, PublicCloneable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -785788354860328359L;
	 ...
	 * 
	 * @param seriesNames
	 *            the names of the series (<code>null</code> not permitted).
	 * @param data
	 *            the wind data.
	 * 
	 * @throws NullPointerException
	 *             if <code>seriesNames</code> is <code>null</code>.
	 */
	 ...
	 * <code>Date</code> or a <code>Number</code> that is the milliseconds since
	 * 1-Jan-1970);</li>
	 ...
	 *            the names of the series (<code>null</code> not permitted).
	 * @param data
	 *            the wind dataset (<code>null</code> not permitted).
	 * 
	 * @throws IllegalArgumentException
	 *             if <code>seriesKeys</code> is <code>null</code>.
	 * @throws IllegalArgumentException
	 *             if the number of series keys does not match the number of
	 *             series in the array.
	 * @throws NullPointerException
	 *             if <code>data</code> is <code>null</code>.
	 */
